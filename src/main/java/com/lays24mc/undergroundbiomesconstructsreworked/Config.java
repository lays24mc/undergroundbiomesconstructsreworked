...
public class Config {
    ...
    public static final ModConfigSpec.IntValue PLACE_GNEISS_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_ECLOGITE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_MARBLE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_BLUESCHIST_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_GREENSCHIST_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_SOAPSTONE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_MIGMATITE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_LIMESTONE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_CHALK_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_SHALE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_SILTSTONE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_LIGNITE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_DOLOMITE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_GREYWACKE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_CHERT_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_RED_GRANITE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_BLACK_GRANITE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_RHYOLITE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_GABBRO_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_KOMATIITE_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue PLACE_DACITE_BLOCK = BUILDER
