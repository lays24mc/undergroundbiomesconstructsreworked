...
public class UBCBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(GreenschistBlocks.GREENSCHIST_BRICK_BLOCK.get())
        ...
        // Slabs
                ...
                .add(DolomitBlocks.DOLOMIT_BLOCK_SLAB.get())
        ...
        // Stairs
                ...
                .add(DolomitBlocks.DOLOMIT_STAIRS.get())
        ...
        // Walls
                ...
                .add(DolomitBlocks.DOLOMIT_BLOCK_WALL.get())
