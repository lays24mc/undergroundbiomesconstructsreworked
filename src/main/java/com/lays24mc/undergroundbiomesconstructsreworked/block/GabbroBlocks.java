...
public class GabbroBlocks {
    ...
    public static final DeferredBlock<Block> GABBRO_BLOCK = registerBlock("gabbro_block",
            () -> new UBCBlocks(MapColor.COLOR_LIGHT_GRAY, 1.0F, 1.0F)
    );
