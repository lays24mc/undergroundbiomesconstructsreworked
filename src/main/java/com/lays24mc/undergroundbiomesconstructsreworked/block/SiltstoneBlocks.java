...
public class SiltstoneBlocks {
    ...
    public static final DeferredBlock<Block> SILTSTONE_BLOCK = registerBlock("siltstone_block",
            () -> new UBCBlocks(MapColor.TERRACOTTA_BROWN, 0.6F, 0.4F)
    );
