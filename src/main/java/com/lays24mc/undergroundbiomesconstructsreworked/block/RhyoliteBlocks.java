...
public class RhyoliteBlocks {
    ...
    public static final DeferredBlock<Block> RHYOLITE_BLOCK = registerBlock("rhyolite_block",
            () -> new UBCBlocks(MapColor.COLOR_LIGHT_GRAY, 1.3F, 1.26F)
    );
